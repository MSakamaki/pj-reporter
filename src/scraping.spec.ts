...
describe('scraping footer testing', () => {
  ...
  it('childSwite', () => {
    ...
    expect(text).toBe(
      '<span>nexted A</span><ul><li>description nest A1</li><li>description nest A2</li></ul>',
    );
  });

  it('makeFotterHtml', () => {
    const text = makeFotterHtml([childRoot, childA, childB]);
    expect(text).toBe(
      '<div class="root"><ul class="fast-root"><li>description text</li><li><span>nexted A</span><ul><li>description nest A1</li><li>description nest A2</li></ul></li><li><span>nexted B</span><ul><li>description nest B1</li><li>description nest B2</li></ul></li></ul></div>',
    );
  });
  ...
  it('fotterSpecs', () => {
    ...
    expect(text).toBe(
      `<style>${getListStyle()}</style><div class="root" style="${style}"><ul class="fast-root"></ul></div>`,
    );
  });
});
